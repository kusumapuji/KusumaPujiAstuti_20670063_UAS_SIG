...
jsonSource_KabupatenDemak_0.addFeatures(features_KabupatenDemak_0);var lyr_KabupatenDemak_0 = new ol.layer.Vector({
    ...
    <img src="styles/legend/KabupatenDemak_0_13.png" /> WONOSALAM<br />'
        });var format_PENGINAPAN_1 = new ol.format.GeoJSON();
var features_PENGINAPAN_1 = format_PENGINAPAN_1.readFeatures(json_PENGINAPAN_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PENGINAPAN_1 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_PENGINAPAN_1.addFeatures(features_PENGINAPAN_1);var lyr_PENGINAPAN_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PENGINAPAN_1, 
                style: style_PENGINAPAN_1,
                title: '<img src="styles/legend/PENGINAPAN_1.png" /> PENGINAPAN'
            });

lyr_KabupatenDemak_0.setVisible(true);lyr_PENGINAPAN_1.setVisible(true);
var layersList = [baseLayer,lyr_KabupatenDemak_0,lyr_PENGINAPAN_1];
lyr_KabupatenDemak_0.set('fieldAliases', {'DESA': 'DESA', 'KECAMATAN': 'KECAMATAN', });
lyr_PENGINAPAN_1.set('fieldAliases', {'nama': 'nama', 'alamat': 'alamat', 'telp': 'telp', 'y': 'y', 'x': 'x', });
lyr_KabupatenDemak_0.set('fieldImages', {'DESA': 'TextEdit', 'KECAMATAN': 'TextEdit', });
lyr_PENGINAPAN_1.set('fieldImages', {'nama': 'TextEdit', 'alamat': 'TextEdit', 'telp': 'TextEdit', 'y': 'TextEdit', 'x': 'TextEdit', });
lyr_KabupatenDemak_0.set('fieldLabels', {'DESA': 'inline label', 'KECAMATAN': 'inline label', });
lyr_PENGINAPAN_1.set('fieldLabels', {'nama': 'inline label', 'alamat': 'inline label', 'telp': 'inline label', 'y': 'no label', 'x': 'no label', });
lyr_PENGINAPAN_1.on('precompose', function(evt) {
