...
var style_LuasWilayah_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("LUAS_WILAY");
    var labelText = "";
    size = 0;
    ...
    if (value > 1.060000 && value <= 6.924000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 6.924000 && value <= 12.788000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 12.788000 && value <= 18.652000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 18.652000 && value <= 24.516000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 24.516000 && value <= 30.380000) {
            style = [ new ol.style.Style({
