...
var style_JumlahPenduduk_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value > 1250.000000 && value <= 7308.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 7308.800000 && value <= 13367.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 13367.600000 && value <= 19426.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 19426.400000 && value <= 25485.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 25485.200000 && value <= 31544.000000) {
            style = [ new ol.style.Style({
