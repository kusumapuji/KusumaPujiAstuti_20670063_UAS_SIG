...
var style_PendudukLaki_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("PRIA");
    var labelText = "";
    size = 0;
    ...
    if (value > 622.000000 && value <= 3633.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 3633.000000 && value <= 6644.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 6644.000000 && value <= 9655.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 9655.000000 && value <= 12666.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 12666.000000 && value <= 15677.000000) {
            style = [ new ol.style.Style({
