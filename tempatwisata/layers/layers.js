...
lyr_KabupatenDemak_0.setVisible(true);lyr_WISATA_1.setVisible(true);
var layersList = [baseLayer,lyr_KabupatenDemak_0,lyr_WISATA_1];
lyr_KabupatenDemak_0.set('fieldAliases', {'DESA': 'DESA', 'KECAMATAN': 'KECAMATAN', });
lyr_WISATA_1.set('fieldAliases', {'nama wisat': 'nama wisat', 'tempat wis': 'tempat wis', });
lyr_KabupatenDemak_0.set('fieldImages', {'DESA': 'TextEdit', 'KECAMATAN': 'TextEdit', });
lyr_WISATA_1.set('fieldImages', {'nama wisat': 'TextEdit', 'tempat wis': 'TextEdit', });
lyr_KabupatenDemak_0.set('fieldLabels', {'DESA': 'inline label', 'KECAMATAN': 'inline label', });
lyr_WISATA_1.set('fieldLabels', {'nama wisat': 'inline label', 'tempat wis': 'inline label', });
