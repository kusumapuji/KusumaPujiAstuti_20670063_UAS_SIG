...
jsonSource_KabupatenDemak_0.addFeatures(features_KabupatenDemak_0);var lyr_KabupatenDemak_0 = new ol.layer.Vector({
    ...
    <img src="styles/legend/KabupatenDemak_0_13.png" /> WONOSALAM<br />'
        });var format_SPBU_1 = new ol.format.GeoJSON();
var features_SPBU_1 = format_SPBU_1.readFeatures(json_SPBU_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SPBU_1 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_SPBU_1.addFeatures(features_SPBU_1);var lyr_SPBU_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SPBU_1, 
                style: style_SPBU_1,
                title: '<img src="styles/legend/SPBU_1.png" /> SPBU'
            });

lyr_KabupatenDemak_0.setVisible(true);lyr_SPBU_1.setVisible(true);
var layersList = [baseLayer,lyr_KabupatenDemak_0,lyr_SPBU_1];
lyr_KabupatenDemak_0.set('fieldAliases', {'DESA': 'DESA', 'KECAMATAN': 'KECAMATAN', });
lyr_SPBU_1.set('fieldAliases', {'daftar spb': 'daftar spb', 'no. telp': 'no. telp', 'y': 'y', 'x': 'x', 'alamat': 'alamat', });
lyr_KabupatenDemak_0.set('fieldImages', {'DESA': 'TextEdit', 'KECAMATAN': 'TextEdit', });
lyr_SPBU_1.set('fieldImages', {'daftar spb': 'TextEdit', 'no. telp': 'TextEdit', 'y': 'TextEdit', 'x': 'TextEdit', 'alamat': 'TextEdit', });
lyr_KabupatenDemak_0.set('fieldLabels', {'DESA': 'inline label', 'KECAMATAN': 'inline label', });
lyr_SPBU_1.set('fieldLabels', {'daftar spb': 'inline label', 'no. telp': 'inline label', 'y': 'no label', 'x': 'no label', 'alamat': 'inline label', });
lyr_SPBU_1.on('precompose', function(evt) {
